...
- [ ] **T401** — FxTwitter client (thread, conversation w/ cursor, syndication fallback)
...
- [ ] **T402** — `x/prepare.py` content.md (thread, quotes, notes, replies) + metadata extras (views, likes, reposts)
...
- [ ] **T403** — Video part: call video prepare, merge transcript, background download
...
- [ ] **T404** — prereq scripts (video tools optional) + SUBSKILL.md (thread vs reactions, reactions via discussion.md) + template.md
...
- [ ] **T405** — E2E: a text thread and a post with video
