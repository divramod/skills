...
- [x] **T001** — chore(plan): detach 0001, 0002, 0003 from the main checkout [claude]
  ...
  - **Files:** docs/plans/0001-summarize-video-v2/hal.yml, docs/plans/0002-featdmsummarizevideo-download-videos-by-default/hal.yml, docs/plans/0003-tell-me-multi-source/hal.yml
  - **Size:** XS (0 LOC)
  - **State:**
    - [x] built
    - [x] tested
