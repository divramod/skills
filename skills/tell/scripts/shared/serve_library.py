...
from _common import browser_cookies, env, library_root, log, read_json, run_main, write_json

DEFAULT_PORT = int(env("TELL_PORT", "TELL_ME_PORT", "DM_SUMMARIZE_VIDEO_PORT") or "8765")
HEADERS = ("X-Tell", "X-Tell-Me", "X-DM-Summarize")  # the POST header; pages rendered before the renames: old names
