...
description: I’ve written a lot about how I’ve been using Claude to build one-shot HTML+JavaScript applications via Claude Artifacts. I recently started using a similar pattern to create one-shot Python utilities, …
sitename: Simon Willison’s Weblog
date: "2024-12-19"
tags: ['aws 73', 'cli 109', 'python 1,284', 's3 64', 'ai 2,247', 'prompt-engineering 197', 'generative-ai 1,992', 'llms 1,958', 'ai-assisted-programming 407', 'claude 312', 'claude-artifacts 36', 'uv 100', 'rich 5', 'prompt-to-app 39', 'starlette 13']
---
...
- [Jev introduces a new shape of LLM - System One, aka Decision Models](https://simonwillison.net/2026/Sep/21/jev/) - 21st September 2026
- [Generating running routes with GPT-6 Astra and ChatGPT Work](https://simonwillison.net/2026/Sep/12/astra-running-routes/) - 12th September 2026
